...
const GenHtmlRegistration = (name, teacherEmail, date, time, status) => {
                  ...
                  >
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                        רצינו לעדכן אותך שסטטוס השיעור השתנה
                        ...
                        <p
                          style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; -webkit-box-sizing: border-box; box-sizing: border-box;"
                        >
                          השיעור עם המורה ${teacherEmail} 
                      
                          שנקבע לתאריך ${date} בשעה ${time}  
                          ${statusJson[status]}
                        </p>
